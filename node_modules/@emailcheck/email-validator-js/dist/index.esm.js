...
function isHighVolume(smtpReply) {
  return Boolean(smtpReply && /(high number of|our system has detected unusual activity|contact your service provider for support|\[irr\])/gi.test(smtpReply));
}
...
async function testSMTPConnection(params) {
  ...
  const activeSequence = {
    ...sequence,
    steps: [...(_a = sequence === null || sequence === void 0 ? void 0 : sequence.steps) !== null && _a !== void 0 ? _a : defaultSteps]
  };
  if (port === 25) {
  ...
  return new Promise((resolve) => {
    ...
    let cleanup = () => {
      ...
      const destroyTimer = setTimeout(() => socket === null || socket === void 0 ? void 0 : socket.destroy(), 100);
      (_a2 = destroyTimer.unref) === null || _a2 === void 0 ? void 0 : _a2.call(destroyTimer);
    };
